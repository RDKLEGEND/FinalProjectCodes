...
import pantImage from'@salesforce/resourceUrl/pantImage';
...
export default class ProductFashion2 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pname=data[3].Name;
            this.pprice=data[3].price__c;
            this.pdescription=data[3].Description__c;
            this.proId=data[3].prod_id__c;
            this.pstock=data[3].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
