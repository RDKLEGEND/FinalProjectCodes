...
import shoeImage from'@salesforce/resourceUrl/shoeImage';
...
export default class ProductFashion4 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pname=data[4].Name;
            this.pprice=data[4].price__c;
            this.pdescription=data[4].Description__c;
            this.proId=data[4].prod_id__c;
            this.pstock=data[4].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
