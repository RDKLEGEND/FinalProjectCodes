...
import BookImage2 from'@salesforce/resourceUrl/BookImage2';
...
export default class ProductBook2 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pname=data[5].Name;
            this.pprice=data[5].price__c;
            this.pdescription=data[5].Description__c;
            this.proId=data[5].prod_id__c;
            this.pstock=data[5].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
