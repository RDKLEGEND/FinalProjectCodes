...
import BookImage1 from'@salesforce/resourceUrl/BookImage1';
...
export default class ProductBook1 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pname=data[11].Name;
            this.pprice=data[11].price__c;
            this.pdescription=data[11].Description__c;
            this.proId=data[11].prod_id__c;
            this.pstock=data[11].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
