...
import hoodieImage from'@salesforce/resourceUrl/hoodieImage';
...
export default class ProductFashion3 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pprice=data[2].price__c;
            this.pdescription=data[2].Description__c;
            this.proId=data[2].prod_id__c;
            this.pstock=data[2].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
