...
import FashionImage1 from'@salesforce/resourceUrl/FashionImage1';
...
export default class ProductFashion1 extends LightningElement {
    ...
    @wire(getPro)proList({data,error}){
        if(data){
            ...
            this.pname=data[6].Name;
            this.pprice=data[6].price__c;
            this.pdescription=data[6].Description__c;
            this.proId=data[6].prod_id__c;
            this.pstock=data[6].StockAvailable__c;
        }
        else if(error){
            console.log(error);
        }
